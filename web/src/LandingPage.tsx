...
const IconCalendar = () => <Calendar size={24} className="text-secondary" aria-hidden="true" />;
const IconRobot = () => <Bot size={24} className="text-secondary" aria-hidden="true" />;
const IconZap = () => <Zap size={24} className="text-secondary" aria-hidden="true" fill="currentColor" />;
const IconGlobe = () => <Globe size={24} className="text-secondary" aria-hidden="true" />;
const IconWifi = () => <Wifi size={24} className="text-secondary" aria-hidden="true" />;
const IconLock = () => <Lock size={24} className="text-secondary" aria-hidden="true" />;
const IconHeart = () => <Heart size={24} className="text-secondary" aria-hidden="true" />;
const IconTicket = () => <Ticket size={24} className="text-secondary" aria-hidden="true" fill="currentColor" />;
const IconShare = () => <Share2 size={24} className="text-secondary" aria-hidden="true" />;
const IconCheckCircle = () => <CheckCircle size={24} className="h-6 w-6 text-green-600" aria-hidden="true" />;
